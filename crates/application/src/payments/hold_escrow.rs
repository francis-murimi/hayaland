...
use crate::payments::dto::{HoldEscrowCommand, TransactionResult};
...
/// Move available balance into escrow for a deal.
#[derive(Clone)]
pub struct HoldEscrow {
